...
func (s *Accounts) GetAddressByUsername() http.Handler {
	return http.HandlerFunc(s.GetAddressByUsernameFunc)
}
...
func (s *Accounts) GetUsername() http.Handler {
	return http.HandlerFunc(s.GetUsernameFunc)
}